...
llm_comparison_page = st.Page("pages/llm_comparison.py", title="LLM vs YOLO (person agnostic)")
checklist_compare_page = st.Page("pages/checklist_compare.py", title="LLM vs YOLO (person detection)")

st.navigation(
    [demo_page, compare_page, performance_page, llm_comparison_page, checklist_compare_page],
    position="top",
).run()
